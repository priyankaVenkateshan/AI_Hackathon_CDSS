...
/**
 * True only when mock is explicitly requested via VITE_USE_MOCK.
 * When false, the app always calls the API (no fallback to local mock data).
 */
