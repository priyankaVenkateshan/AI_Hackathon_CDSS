...
|-----|------|------|------------|
| Doctor dashboard | `apps/doctor-dashboard` | 5173 | priya@cdss.ai / password123 |
| Patient portal | `apps/patient-dashboard` | 5174 | patient@cdss.ai / password123 |
| Nurse dashboard | `apps/nurse-dashboard` | 5175 | anjali@cdss.ai / password123 |
